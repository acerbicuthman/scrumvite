...
const WhyChooseUs = () => {
  return (
    <div className='text-white my-4 px-4'>
        ...
        <motion.p
          ...
          >
            <p>Experience the future of learning with our cutting-edge platform</p>
            </motion.p>
        </div>
  ...
  <motion.div
    ...
    <div className='flex-1 m-5'>
      ...
      <p className='text-gray-400'>Our intelligent system pairs you with the perfect tutor based on your learning style and goals.</p>
    </div>
  ...
  <motion.div
    ...
    <div className='flex-1 m-5 py-auto'>
      ...
      <p className='text-gray-400' >Engage in real-time learning with advanced video conferencing and collaborative tools.</p>
    </div>
    <div className="flex-1 mx-5">
    <motion.img
              src={Pana}
  ...
  <motion.div
    ...
    <div className='flex-1 m-5'>
      ...
      <p className='text-gray-400'>Book sessions at your convenience with our smart calendar system.</p>
    </div>
    <div className="flex-1 mx-5">
            <motion.img
              src={Bro}
