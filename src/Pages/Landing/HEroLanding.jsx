    ...
    <div className="mb-20">
      <div className="relative h-[90vh] overflow-hidden rounded-b-[600px] pb-10">
        ...
        <img
          src={ManInSuit}
          alt=""
          className="absolute object-cover md:bg-contain md:top-0 md:right-12 md:object-contain md:h-full h-3/4 bottom-0 ml-36"
        />
        <div className="relative z-20 flex pt-36 flex-col md:items-center md:justify-center h-full text-center px-10 ">
          <h1 className="md:text-6xl text-3xl font-bold bg-gradient-to-r from-[#AB4DFF] to-[#4318D1] text-transparent bg-clip-text mb-4 ">
          ...
          <div className="md:flex mt-10 ">
            <button
              ...
              className="bg-blue-700 text-white md:px-10 py-4 rounded-lg md:mx-4 mb-5 w-full text-nowrap "
            >
              Become a Tutor
            </button>
            <button
              onClick={() => handleNavigateType("learner")}
              className="bg-white border-blue-700 border-2 text-blue-700 md:px-10 py-4 rounded-lg md:mx-4 mb-5 w-full "
            >
              Start Learning
            </button>
          </div>
