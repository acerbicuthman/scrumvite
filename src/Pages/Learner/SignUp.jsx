...
const SignUp = () => {
  ...
  const handleAuthCodeChange = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://scrum-lms-backend.onrender.com/api/auth/registration/', data);
    ...
    <div className="flex flex-col md:flex-row h-screen sm:p-6 md:overflow-hidden overflow-x-hidden">
      ...
      <div className="flex-1 px-6 sm:px-8 md:px-12 mb-4 md:mb-4 xl:py-18 2xl:py-96 h-screen overflow-x-hidden">
        <div className="w-full max-w-lg mx-auto pt-8 xl:h-screen ">
          ...
          >
            <div>
              <label htmlFor="first_name" className="text-sm sm:text-base md:text-base xl:text-sm font-medium text-gray-600">First Name</label>
              <input
                type="text"
                value={first_name}
            ...
            <div>
              <label htmlFor="last_name" className="text-sm sm:text-base md:text-base xl:text-sm font-medium text-gray-900">Last Name</label>
              <input
                type="text"
                value={last_name}
            ...
            <div>
              <label htmlFor="email" className="text-sm sm:text-base md:text-base xl:text-sm font-medium text-gray-900">Email address</label>
              <input
                type="email"
                name="email"
                id="email"
                ...
                required
                className={`block w-full border rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-600 ${email && (isEmailValid ? "valid-input" : "invalid-input")}`}
              />
              {!isEmailValid && email && <div className="text-red-600 text-xs mt-1">Please enter a valid email</div>}
            </div>

            <div>
              <label htmlFor="password1" className="text-sm sm:text-base md:text-base xl:text-sm font-medium text-gray-900">Create Password</label>
            ...
            <div>
              <label htmlFor="password2" className="text-sm sm:text-base md:text-base xl:text-sm font-medium text-gray-900">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <div className="flex flex-col">
              <label htmlFor="account_type" className="text-sm font-medium text-gray-700">Choose Your Account Type</label>
              <select
                id="account_type"
                value={account_type} onChange={handleChange}
                name="accountType"
            ...
            <div className="text-center py-3">
              ...
              <button
                type="submit"
                disabled={!isPasswordValid || !isConfirmPasswordValid || !isEmailValid || !checkBoxValid}
