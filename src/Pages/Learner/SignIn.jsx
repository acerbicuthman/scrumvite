...
<ImageSlideShow />
    ...
    <div className="flex-1 md:mt-12 px-4 sm:px-8 md:px-12 mb-4 md:mb-1 xl:py-18 h-screen overflow-x-hidden xl:mb-1 lg:mb- lg:min-h-screen lg:overflow-hidden">
      <div className="w-full max-w-lg mx-auto pt-8  ">
        ...
        <div className="text-center md:px-0 px-2 lg:text-base text-sm mb-4 md:text-xs  md:text-nowrap xl:text-base">
          <p>
          <span className="md:hidden ">Welcome,</span> Login back in to and continue your learning journey
        ...
        />
        <span className="mt-2 text-sm text-nowrap md:hidden lg:block lg:text-sm">Sign up with Google</span>
      </button>
              ...
              <div className="rounded-xl border-2 p-2 ">
                <button className="flex gap-4 md:gap-1 ">
                        <img
                          ...
                          className="w-8 h-8  object-contain "
                        />
                    <span className="mt-2 text-sm text-nowrap md:hidden lg:block lg:text-sm">Sign up with LinkedIn</span>
                      </button>
  ...
  <div className="w-2/3 text-center">
    <button type="submit"
    className="bg-blue-800 w-full py-2 rounded-lg">Continue</button>
  </div>
</div>
            </form>
              </div>
