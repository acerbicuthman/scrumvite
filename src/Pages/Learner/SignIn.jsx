...
const SignIn = () => {
  return (
    <div className='mt-20 flex items-center justify-center md:flex-row h-screen bg-slate-300'>
    ...
    <img src={displayimg} alt="" />
      ...
      <div className='  bg-white h-screen w-full p-20
       '>
        ...
        <button className='bg-indigo-900 text-white py-3 rounded-lg w-full '>Continue</button>
      </div>
