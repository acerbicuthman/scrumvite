...
const Footer = () => {
  return (
    <footer className="bg-gray-900 md:px-36 text-left w-full md:block hidden ">
      <div
    ...
    gap-10 md:gap-10 py-10 border-b border-white/30"
      >
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center text-sm md:text-left text-white/80">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni unde
            natus voluptate, totam nemo obcaecati ex eaque impedit dolores
            necessitatibus.
          </p>
        </div>
        <div className="flex flex-col md:items-start items-center w-full">
      ...
      <p className="py-4 text-center text-xs md:text-sm text-white/60">
        &copy; 2025 Scrum Consult. All Rights Reserved.
      </p>
    </footer>
  );
};
