...
<p>Your email is verified, and your learning journey officially begins.</p>   
<p> Let’s dive in!</p>
<Link to='/expired_link_page'>
<button className='bg-blue-900 text-white text-xs my-8 lg:px-20 px-20 py-3  rounded-lg'>Go to dashboard</button>
</Link>
 </div>
